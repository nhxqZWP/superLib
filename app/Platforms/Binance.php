...
class Binance
{
     ...
     *
     * No arguments - use file setup 没有参数 使用配置文件
...
//        $file = is_null($file) ? getenv("HOME") . "/.config/jaggedsoft/php-binance-api.json" : $file;
    ...
    /**
     * buyTest attempts to create a TEST currency order  下测试单
     *
     * @see buy()
     *
     * @param $symbol string the currency symbol
    ...
    /**
     * marketBuy attempts to create a currency order at given market price 市价买单
     *
     * $quantity = 1;
    ...
    /**
     * marketBuyTest attempts to create a TEST currency order at given market price 市价买单测试
     *
     * @see marketBuy()
     *
     * @param $symbol string the currency symbol
